...
namespace Airline_reservation
{
    public partial class contact : Form
    {
        ...
        private void contactbutton_Click(object sender, EventArgs e) //Listener Function when contact button is clicked
        {
            ...
            {
                String query = "Insert into contactmessages(fname, lname, email, suggetion, sugdate) values('"+ usernametextbox.Text+"', '"+ lastnametextbox.Text+"', '"+ emailtextbox.Text+"', '"+ messagetextbox.Text+"', getdate()); ";
